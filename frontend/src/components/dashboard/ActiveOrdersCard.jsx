...
export default function ActiveOrdersCard({ activeOrdersCount }) {
  ...
  return (
    <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-100 shadow-sm mb-10 relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6 relative z-10">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h3 className="text-xl font-bold text-slate-800">You have {activeOrdersCount} active {activeOrdersCount === 1 ? 'order' : 'orders'}!</h3>
            <p className="text-slate-600 font-medium">Your food is being prepared and will be on its way soon.</p>
          </div>
        </div>
